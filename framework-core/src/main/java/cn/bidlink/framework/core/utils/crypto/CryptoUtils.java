package cn.bidlink.framework.core.utils.crypto;
...
public class CryptoUtils {
	 ...
	 */
	@Deprecated
	public synchronized void encryptFilePBE(File plaintextFile, File cipherFile,
	 ...
	 */
	@Deprecated
	public synchronized void decryptFilePBE(File cipherFile,File plaintextFile, 
			Integer cacheSize, String key) throws Exception {
		InputStream datain = null;
		OutputStream dataOut = null;
		int size = 0;
		...
		try {
			...
			datain = new java.io.DataInputStream(new BufferedInputStream(
					new FileInputStream(cipherFile)));
			dataOut = new DataOutputStream(new BufferedOutputStream(
					new FileOutputStream(plaintextFile)));
			old = new byte[size];
	 ...
	 * @throws Exception
	 */
	public synchronized void encryptFileAES(File plaintextFile, File cipherFile,
			Integer cacheSize, String key) throws Exception {
		InputStream datain = null;
		OutputStream dataOut = null;
		int size = 0;
	 ...
	 * @throws Exception
	 */
	public synchronized void decryptFileAES(File cipherFile,File plaintextFile, 
			Integer cacheSize, String key) throws Exception {
		InputStream datain = null;
		OutputStream dataOut = null;
		int size = 0;
