package cn.bidlink.framework.web.view.json;
...
public class BidMappingJacksonJsonView extends AbstractView {
	 ...
	 * 日期格式化 KEY
	 */
	private String DATE_FORMAT = DateUtils.DATE_FORMAT;

	/**
	 * 排除字段
	 */
	private String EXECUTE_FIELDS = Constants.EXECUTE_FIELDS;

	/**
	 * 包含字段
	 */
	private String INCLUDE_FIELDS = Constants.INCLUDE_FIELDS;
