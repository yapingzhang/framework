 ...
 * 
 */
public class BidQueueAsynMsgListener implements MessageListener,
		ApplicationContextAware, InitializingBean,Ordered {
	private static Logger logger = Logger.getLogger(BidQueueAsynMsgListener.class);
	...
	public void afterPropertiesSet() throws Exception {
		System.out.println("BidQueueAsynMsgListener instance is created..........");
	...
	public static void setBidMessageHandler(BidMessageHandler bidMessageHandler) {
		BidQueueAsynMsgListener.bidMessageHandler = bidMessageHandler;
	}
