...
//			boundSql = showParams(boundSql.getParameterMappings(), boundSql);
						...
						Object obj = field.get(parameter); //FieldUtils.getProtectedFieldValue(field2.getName(), parameter);
	                     if (obj != null) {
	                    	 ...
	                    	 if (paramStr.trim().contains("%")) {
	                        	...
	                        	// FieldUtils.setProtectedFieldValue(field2.getName(), parameter, paramStr);
...
//    
//	private BoundSql  showParams (List<ParameterMapping>  lists,BoundSql boundSqlX) {
...
//			 if (i == lists.size() -1) {
//				    boundSqlX.setAdditionalParameter(param.getProperty(), "中华人民共和国");
// 					System.out.println(boundSqlX.getAdditionalParameter(param.getProperty()));
//			 } else {
//				 System.out.println(boundSqlX.getAdditionalParameter(param.getProperty()));
//			 }
//		}
//		System.out.println(ToStringBuilder.reflectionToString(boundSqlX));
//		return boundSqlX;
//	}
